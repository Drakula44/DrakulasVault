[
	...
	{trigger: "NN", replacement: "\\mathcal{N}", options: "mA"},
	...
	{trigger: "\\\\(${GREEK}|${SYMBOL}) inv", replacement: "\\[[0]]^{-1}", options: "rmA"},
	...
	// generate partial derivative of n order with par\d
	{trigger: /par(\d)/, replacement: "\\frac{ \\partial^{[[0]]} $0 }{ \\partial $1^{[[0]]} } $2", options: "mA", priority: 1},
